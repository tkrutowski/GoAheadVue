  ...
  <nav class="bg-[#2f363c] relative min-h-[50px]">
    <div class="flex items-center justify-between px-4 min-h-[50px]">
      ...
      <div class="flex items-center justify-center gap-0">
        <div v-for="item in menuItems" :key="item.key" class="menu-item-container relative">
          <!-- Przycisk menu -->
          <button
            :class="[
          ...
          >
            ...
            ></i>
            <div v-if="activeMenu === item.key" class="absolute bottom-0 left-0 right-0 h-0.5 bg-primary-100"></div>
          </button>
