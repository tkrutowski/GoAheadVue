...
<template>
  ...
  <div class="m-4 max-w-6xl mx-auto">
    <form class="col-12 col-md-9 col-xl-6 align-self-center" @submit.stop.prevent="saveSupplier">
      <Panel>
        <template #header>
          <OfficeIconButton
        ...
        <div class="flex flex-col gap-4 mb-3">
          <div class="flex flex-col w-full">
            <label class="pl-1 pb-1 text-surface-800 dark:text-surface-400" for="supplier-name">Nazwa dostawcy</label>
            <InputText
              id="supplier-name"
        ...
        <div class="flex flex-row flex-wrap gap-4">
          <div class="flex flex-col w-full min-w-[12rem] flex-1">
            ...
            <small class="p-error">{{ showErrorNip() ? 'Pole NIP musi mieć 10 cyfr.' : '\u00A0' }}</small>
          </div>
          <div class="flex flex-col w-full min-w-[10rem] flex-1">
            ...
            <InputText id="regon" v-model="supplier.regon" maxlength="14" size="large" />
            <small class="p-error">&nbsp;</small>
          </div>
          <div class="flex flex-col w-full min-w-[12rem] flex-1">
            <label class="pl-1 pb-1 text-surface-800 dark:text-surface-400" for="accountNumber">Nr konta</label>
            <InputText id="accountNumber" v-model="supplier.accountNumber" maxlength="64" size="large" />
            <small class="p-error">&nbsp;</small>
          </div>
        </div>
        ...
        <div class="flex flex-row flex-wrap gap-4 mt-2">
          ...
          <div class="flex flex-col w-full min-w-[8rem] max-w-[10rem]">
            ...
            <InputText id="zip" v-model="supplier.address.zip" maxlength="6" :invalid="showErrorZip()" size="large" />
          ...
          <div class="flex flex-col w-full min-w-[10rem] flex-1">
            ...
            <InputText id="city" v-model="supplier.address.city" maxlength="100" :invalid="showErrorCity()" size="large" />
        ...
        <div class="flex flex-col sm:flex-row gap-4 mt-4 w-full">
          <div class="flex flex-col flex-1">
            ...
            <InputText id="mail" v-model="supplier.mail" class="border-green" :invalid="showErrorMail()" maxlength="100" size="large" />
          ...
          <div class="flex flex-col flex-1">
            ...
            <InputText id="phone" v-model="supplier.phone" maxlength="15" :invalid="showErrorPhone()" size="large" />
